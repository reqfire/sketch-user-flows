...
var insertionSort = __webpack_require__(3).insertionSort;
...
exports["default"] = function (context) {
  return exportInterfaces(context, false);
};

var getJSONFromURL = __webpack_require__(0).getJSONFromURL;
...
// var uploadStatus;
// var jsonInput;
// const jsonUrl = "https://www.reqfire.com/app/project/sketchexport/";
...
//         "Please ensure you have at least one symbol artboard selected.",
//         "Error — No symbol artboard selected for sync"
//     );
// } else {
//     if (checkSymbols(layers).length < 1) {
//         app.displayDialog_withTitle(
//             "Please ensure the symbol artboards selected aren't empty.",
//             "Error — Unable to sync current selection"
//         );
//     } else {
...
//             //get file content
//             var manifest = NSJSONSerialization.JSONObjectWithData_options_error(
...
//             var exportPath = NSTemporaryDirectory() + "sketch-reqfire-export/"; // set a temporary path
//             var exportInfoList = layersToPNG(context, checkSymbols(layers));
...
//                         if (uploadStatus == 1) {
//                             app.displayDialog_withTitle(
//                                 "Please refresh your Reqfire project to see the changes.",
//                                 "Success — Your project has been synced successfully"
//                             );
//                         } else if (uploadStatus == 2) {
//                             app.displayDialog_withTitle(
//                                 "Please ensure you are using a valid API key.\nThis can be found within your project at Reqfire > Export > Sync to Sketch.",
//                                 "Error — Invalid API key provided"
//                             );
//                         } else if (uploadStatus == 3) {
//                             // TODO - delete this
//                             app.displayDialog_withTitle(
//                                 "Unmatched project key and api key!",
//                                 "Unable to Export"
//                             );
//                         } else {
...
//                         print(layers.length);
//                     } else {
//                         log("User has cancelled Export Selected.")
//                         // app.displayDialogue_withTitle("Export cancelled");
//                     }
//                 } else {
//                     app.displayDialog_withTitle(
//                         "You can download the latest version from https://github.com/reqfire/sketch-user-flows/",
//                         "Error — Plugin version is not up to date"
//                     );
//                 }
//             } else {
//                 app.displayDialog_withTitle(
...
//         var exportRequest = MSExportRequest.exportRequestsFromExportableLayer(
//             mslayer
//         ).firstObject();
...
//         args.addObject("-F");
//         args.addObject(
//             list[i]["layerName"].split(" id:")[1] + "=@" + list[i]["path"]
//         );
//     }
...
//     if (classNameOfOutput != "_NSZeroData") {
//         var res = NSJSONSerialization.JSONObjectWithData_options_error(
//             data,
...
//     const flattenByKey = function(object, property) {
//         return Object.keys(object[property]).map(function(key) {
//             return object[property][key];
//         });
//     };
...
// //check selection is symbol or not, and check if it is symbol with no child
...
//         exportInfoList.length +
//         " Symbol" +
//         plural +
//         " selected to be synced with your Reqfire project — " + projectName
//     );
...
//         "com.bohemiancoding.sketch.exportSelectedInterface"
//     );
...
//     var alertLabel = NSTextField.alloc().initWithFrame(
//         NSMakeRect(0, viewHeight - 40, viewWidth - 100, 35)
//     );
//     var infoLabel = NSTextField.alloc().initWithFrame(
//         NSMakeRect(0, viewHeight - 80, viewWidth - 100, 35)
//     );
//     var jsonLabel = NSTextField.alloc().initWithFrame(
//         NSMakeRect(0, viewHeight - 105, viewWidth - 100, 20)
//     );

//     alertLabel.setStringValue(
//         "Note: Any symbols you create that is not sitting inside the symbol artboards generated by Sketch User Flows will not be synced up to your Reqfire project."
//     );
...
//         "Your Reqfire Project API key can be found within your project at Reqfire > Export > Sync to Sketch."
//     );
...
//     jsonTextField = NSTextField.alloc().initWithFrame(
//         NSMakeRect(0, viewHeight - 125, 300, 20)
//     );
...
// function getJsonValue(context) { //get value by the key
...
//     task.launch();
// }
var exportInterfaces = __webpack_require__(4).exportInterfaces;
...
var getJSONFromURL = __webpack_require__(0).getJSONFromURL;
var getImageFromURL = __webpack_require__(0).getImageFromURL;
var organiseData = __webpack_require__(0).organiseData;
var logRequest = __webpack_require__(0).logRequest;
var getInputFromUser = __webpack_require__(5).getInputFromUser;
var EXPORT_ALL = __webpack_require__(1).EXPORT_ALL;
var EXPORT_SELECTED = __webpack_require__(1).EXPORT_SELECTED;
...
var IMPORT = __webpack_require__(1).IMPORT;
var EXPORT_ALL = __webpack_require__(1).EXPORT_ALL;
var EXPORT_SELECTED = __webpack_require__(1).EXPORT_SELECTED;
